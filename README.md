# Obsidian Page Preview Helper

As of Obsidian v1.5.3, the core "Page Preview" plugin does not respect the user's setting about whether to require `cmd`/`ctrl` when hovering over a link in a callout in Live Preview mode.

This plugin fixes this behavior.
...
3. Open the following URL in your browser: `obsidian://brat?plugin=RyotaUshio/obsidian-page-preview-helper`.
